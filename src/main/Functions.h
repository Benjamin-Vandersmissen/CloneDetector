...
void calculate_and_plot(const std::string &filename, const std::filesystem::path &output_directory);

void calculate_and_plot_directory(const std::filesystem::path &directory, const std::filesystem::path &output_directory);
